...
#define L1 (39.6f) //前后腿的距离
#define init_h 18.0f
#define FORWARD_hight 15.0f
#define BACK_hight 15.0f

#define shortK_hight 18.0f
#define longK_hight   14.0f
// 机器马运动模式
typedef enum
{
    NORMAL = 0,
...
extern LegGain state_gait_gains[END+1];                  //运行状态PID参数
